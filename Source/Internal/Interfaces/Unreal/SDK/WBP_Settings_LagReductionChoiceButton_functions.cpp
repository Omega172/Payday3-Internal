...
#include "WBP_Settings_LagReductionChoiceButton_classes.hpp"
#include "WBP_Settings_LagReductionChoiceButton_parameters.hpp"
...
void UWBP_Settings_LagReductionChoiceButton_C::ExecuteUbergraph_WBP_Settings_LagReductionChoiceButton(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Settings_LagReductionChoiceButton_C", "ExecuteUbergraph_WBP_Settings_LagReductionChoiceButton");

	Params::WBP_Settings_LagReductionChoiceButton_C_ExecuteUbergraph_WBP_Settings_LagReductionChoiceButton Parms{};
...
// Function WBP_Settings_LagReductionChoiceButton.WBP_Settings_LagReductionChoiceButton_C.OnInitialized
// (BlueprintCosmetic, Event, Public, BlueprintEvent)

void UWBP_Settings_LagReductionChoiceButton_C::OnInitialized()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Settings_LagReductionChoiceButton_C", "OnInitialized");
...
void UWBP_Settings_LagReductionChoiceButton_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Settings_LagReductionChoiceButton_C", "PreConstruct");

	Params::WBP_Settings_LagReductionChoiceButton_C_PreConstruct Parms{};
...
void UWBP_Settings_LagReductionChoiceButton_C::RefreshVisuals()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Settings_LagReductionChoiceButton_C", "RefreshVisuals");
...
void UWBP_Settings_LagReductionChoiceButton_C::UpdateOptionsText()
{
	static class UFunction* Func = nullptr;
