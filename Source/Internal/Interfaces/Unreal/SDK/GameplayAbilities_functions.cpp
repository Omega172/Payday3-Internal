...
void UAbilitySystemComponent::Multicast_SetAvatarActor(class AActor* NewAvatarActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AbilitySystemComponent", "Multicast_SetAvatarActor");

	Params::AbilitySystemComponent_Multicast_SetAvatarActor Parms{};
...
// (Net, NetReliable, Native, Event, NetMulticast, Public)
// Parameters:
// class AActor*                           NewOwnerActor                                          (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAbilitySystemComponent::Multicast_SetOwnerActor(class AActor* NewOwnerActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AbilitySystemComponent", "Multicast_SetOwnerActor");

	Params::AbilitySystemComponent_Multicast_SetOwnerActor Parms{};

	Parms.NewOwnerActor = NewOwnerActor;
...
void UAbilitySystemComponent::Multicast_SetOwnerAvatarActor(class AActor* NewOwnerActor, class AActor* NewAvatarActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AbilitySystemComponent", "Multicast_SetOwnerAvatarActor");

	Params::AbilitySystemComponent_Multicast_SetOwnerAvatarActor Parms{};
