...
struct WBP_MainMenu_Loadout_ArmorModCategoryButton_C_ButtonFocusedChanged
{
public:
...
// 0x0001 (0x0001 - 0x0000)
struct WBP_MainMenu_Loadout_ArmorModCategoryButton_C_ButtonHoveredChanged
{
public:
...
struct WBP_MainMenu_Loadout_ArmorModCategoryButton_C_ExecuteUbergraph_WBP_MainMenu_Loadout_ArmorModCategoryButton
{
public:
	...
	const class USBZArmorSettings*                CallFunc_Get_ReturnValue;                          // 0x0098(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FSBZArmorChunkTypeData                 CallFunc_GetChunkData_ReturnValue;                 // 0x00C0(0x0054)(ConstParm, NoDestructor)
};

// Function WBP_MainMenu_Loadout_ArmorModCategoryButton.WBP_MainMenu_Loadout_ArmorModCategoryButton_C.OnFocusChanged
// 0x0028 (0x0028 - 0x0000)
struct WBP_MainMenu_Loadout_ArmorModCategoryButton_C_OnFocusChanged
{
public:
...
// 0x0001 (0x0001 - 0x0000)
struct WBP_MainMenu_Loadout_ArmorModCategoryButton_C_PreConstruct
{
public:
