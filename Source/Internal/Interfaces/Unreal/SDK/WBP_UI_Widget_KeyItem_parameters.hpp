...
struct WBP_UI_Widget_KeyItem_C_ExecuteUbergraph_WBP_UI_Widget_KeyItem
{
public:
	...
	class USBZKeyItemData*                        K2Node_Event_InKeyItemData;                        // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct WBP_UI_Widget_KeyItem_C_OnKeyItemCountChanged
{
public:
...
struct WBP_UI_Widget_KeyItem_C_OnKeyItemPickedUp
{
public:
	class USBZKeyItemData*                        InKeyItemData;                                     // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct WBP_UI_Widget_KeyItem_C_UpdateStackCount
{
public:
