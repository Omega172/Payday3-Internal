...
#include "BP_Keypad_Req_deactivated_classes.hpp"
#include "BP_Keypad_Req_deactivated_parameters.hpp"
...
bool UBP_Keypad_Req_deactivated_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Keypad_Req_deactivated_C", "BP_CheckRequirement");

	Params::BP_Keypad_Req_deactivated_C_BP_CheckRequirement Parms{};
