...
#include "BP_Req_genericHackableComputer_classes.hpp"
#include "BP_Req_genericHackableComputer_parameters.hpp"
...
bool UBP_Req_genericHackableComputer_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Req_genericHackableComputer_C", "BP_CheckRequirement");

	Params::BP_Req_genericHackableComputer_C_BP_CheckRequirement Parms{};
