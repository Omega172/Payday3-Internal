...
// BlueprintGeneratedClass BP_Zipline_Vertical.BP_Zipline_Vertical_C
// 0x0048 (0x0378 - 0x0330)
class ABP_Zipline_Vertical_C final : public ASBZZipline
{
public:
...
public:
	void ExecuteUbergraph_BP_Zipline_Vertical(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Zipline_Vertical_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Zipline_Vertical_C")
	}
	static class ABP_Zipline_Vertical_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Zipline_Vertical_C>();
	}
};
DUMPER7_ASSERTS_ABP_Zipline_Vertical_C;
