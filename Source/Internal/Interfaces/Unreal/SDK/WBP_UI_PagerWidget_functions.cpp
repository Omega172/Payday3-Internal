...
// int32                                   RemainingPagers_0                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32*                                  State                                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_UI_PagerWidget_C::GetPagerStatus(int32 InPagerMax, int32 RemainingPagers_0, int32* State)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_PagerWidget_C", "GetPagerStatus");

	Params::WBP_UI_PagerWidget_C_GetPagerStatus Parms{};

	Parms.InPagerMax = InPagerMax;
	Parms.RemainingPagers_0 = RemainingPagers_0;
