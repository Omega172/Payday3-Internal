...
public:
	...
	TDelegate<void(bool bSabotaged)>              K2Node_CreateDelegate_OutputDelegate;              // 0x000C(0x0014)(ZeroConstructor, NoDestructor)
	...
	float                                         CallFunc_GetCustomPrimitiveDataFloat_ReturnValue;  // 0x0094(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Greater_FloatFloat_ReturnValue;           // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_99[0x3];                                       // 0x0099(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_1;            // 0x009C(0x0014)(ZeroConstructor, NoDestructor)
...
// Function BP_StaticInteraction_SprinklerSystem.BP_StaticInteraction_SprinklerSystem_C.GetMarkerText
// 0x0018 (0x0018 - 0x0000)
struct BP_StaticInteraction_SprinklerSystem_C_GetMarkerText final
{
public:
	class FText                                   ReturnValue;                                       // 0x0000(0x0018)(Parm, OutParm, ReturnParm)
};
DUMPER7_ASSERTS_BP_StaticInteraction_SprinklerSystem_C_GetMarkerText;
