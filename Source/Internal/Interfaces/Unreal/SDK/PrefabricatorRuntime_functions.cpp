...
TArray<class AActor*> APrefabInstancingBaseActor::Uninstancify()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PrefabInstancingBaseActor", "Uninstancify");

	Params::PrefabInstancingBaseActor_Uninstancify Parms{};
