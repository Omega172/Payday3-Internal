...
{
public:
	class UDataflowComponent*                     DataflowComponent;                                 // 0x0328(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
{
public:
	uint8                                         Pad_558[0x148];                                    // 0x0558(0x0148)(Fixing Struct Size After Last Property [ Dumper-7 ])
