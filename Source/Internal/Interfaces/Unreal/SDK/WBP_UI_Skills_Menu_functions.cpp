...
void UWBP_UI_Skills_Menu_C::DescriptionScrollAxisChanged(double Value)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UWBP_UI_Skills_Button_C*          InButton                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                                    bWasHoveredFocus                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// class UWBP_UI_Skills_Line_C*            FocusedSkillLine                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UWBP_UI_Skills_Button_C*          OldFocusedButton                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UWBP_UI_Skills_Button_C*          CurrentFocusedButton                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UWBP_UI_Skills_Button_C**         NewFocusedButton                                       (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UWBP_UI_Skills_Line_C*            SkillLineWidget                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// class UWBP_UI_Loadout_SkillsCustomization_C*parent_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
