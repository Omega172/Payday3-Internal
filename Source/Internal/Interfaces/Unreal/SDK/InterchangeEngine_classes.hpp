...
public:
	...
	struct FSoftObjectPath                        ConverterDefaultPipeline;                          // 0x0280(0x0028)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FInterchangeGroup>              InterchangeGroups;                                 // 0x02A8(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
{
public:
	bool                                          bShowImportDialogAtReimport;                       // 0x0048(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_49[0x3];                                       // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   UsedGroupName;                                     // 0x004C(0x000C)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGuid                                  UsedGroupUID;                                      // 0x0058(0x0010)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class UInterchangePythonPipelineBase*         GeneratedPipeline;                                 // 0x0060(0x0008)(Edit, ZeroConstructor, Transient, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	class UInterchangeBaseNodeContainer*          NodeContainer;                                     // 0x0068(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	TArray<class UObject*>                        Pipelines;                                         // 0x0070(0x0010)(ZeroConstructor, Deprecated, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	class UInterchangeBaseNodeContainer*          TransientNodeContainer;                            // 0x0080(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	TArray<class UObject*>                        TransientPipelines;                                // 0x0088(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	class UInterchangeTranslatorSettings*         TransientTranslatorSettings;                       // 0x0098(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	TSet<TSubclassOf<class UObject>>              RegisteredTranslatorsClass;                        // 0x0210(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	TMap<TSubclassOf<class UObject>, TSubclassOf<class UObject>> RegisteredFactoryClasses;           // 0x0260(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	TMap<TSubclassOf<class UObject>, class UInterchangeWriterBase*> RegisteredWriters;               // 0x02B0(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	TMap<TSubclassOf<class UObject>, class UInterchangeAssetImportDataConverterBase*> RegisteredConverters; // 0x0300(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
