...
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_ButtonFocusedChanged
{
public:
...
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_ExecuteUbergraph_WBP_UI_Inventory_StoreWeaponSlotButton
{
public:
	...
	bool                                          K2Node_Event_bInIsTransactionInProgress;           // 0x0011(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_GetColorByCurrency
{
public:
...
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_InitializeItemData
{
public:
...
// 0x0001 (0x0001 - 0x0000)
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_OnHover
{
public:
...
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_OnTransactionInProgress
{
public:
...
// 0x0001 (0x0001 - 0x0000)
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_OnTransactionProgressChanged
{
public:
...
// 0x0001 (0x0001 - 0x0000)
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_PreConstruct
{
public:
...
// 0x0010 (0x0010 - 0x0000)
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_SetPrice
{
public:
...
struct WBP_UI_Inventory_StoreWeaponSlotButton_C_UpdateHighlights
{
public:
