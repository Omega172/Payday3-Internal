...
{
public:
	uint8                                         Pad_158[0x2A0];                                    // 0x0158(0x02A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x0340 (0x0498 - 0x0158)
class UInterchangeAnimSequenceFactoryNode final : public UInterchangeFactoryBaseNode
{
public:
	uint8                                         Pad_158[0x340];                                    // 0x0158(0x0340)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1D8[0x98];                                     // 0x01D8(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x0180 (0x02D8 - 0x0158)
class UInterchangeMeshFactoryNode : public UInterchangeFactoryBaseNode
{
public:
	uint8                                         Pad_158[0x180];                                    // 0x0158(0x0180)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2D8[0x118];                                    // 0x02D8(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_158[0xD0];                                     // 0x0158(0x00D0)(Fixing Struct Size After Last Property [ Dumper-7 ])
