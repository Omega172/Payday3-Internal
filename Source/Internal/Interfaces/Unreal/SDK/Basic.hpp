...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09150DA0;
	constexpr int32 AppendString      = 0x010E5220;
	constexpr int32 GNames            = 0x090191F0;
	constexpr int32 GWorld            = 0x092E5098;
	constexpr int32 ProcessEvent      = 0x012C7A74;
...
class TFieldPath : public FFieldPath
{
};
