...
namespace Offsets
{
	constexpr int32 GObjects          = 0x070DC8F0;
	constexpr int32 AppendString      = 0x019DF9E0;
	constexpr int32 GNames            = 0x07084A40;
	constexpr int32 GWorld            = 0x0721E170;
	constexpr int32 ProcessEvent      = 0x01BDA3B0;
