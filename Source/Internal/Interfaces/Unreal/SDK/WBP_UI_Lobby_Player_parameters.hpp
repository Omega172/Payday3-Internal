...
struct WBP_UI_Lobby_Player_C_ExecuteUbergraph_WBP_UI_Lobby_Player
{
public:
...
struct WBP_UI_Lobby_Player_C_GetLobbyInfo
{
public:
...
struct WBP_UI_Lobby_Player_C_OnLobbyUpdate
{
public:
...
// 0x0001 (0x0001 - 0x0000)
struct WBP_UI_Lobby_Player_C_OnMMStopped
{
public:
	ESBZOnlineCode                                ErrorCode;                                         // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct WBP_UI_Lobby_Player_C_SetPlayerUIInfo
{
public:
