...
void UWBP_UI_MainMenu_BlackMarketVendors_C::OnActiveVendorIndexChanged(int32 Index_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_MainMenu_BlackMarketVendors_C", "OnActiveVendorIndexChanged");

	Params::WBP_UI_MainMenu_BlackMarketVendors_C_OnActiveVendorIndexChanged Parms{};
