...
struct BP_MapPinManager_C_ExecuteUbergraph_BP_MapPinManager
{
public:
	...
	class ABP_MapPinHelper_C*                     CallFunc_Array_Get_Item;                           // 0x0020(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
