...
struct WBP_DailyChallengeReward_C_ExecuteUbergraph_WBP_DailyChallengeReward
{
public:
	...
	struct FSBZChallengeRewardItem                K2Node_CustomEvent_InRewardItem;                   // 0x0088(0x0030)()
	...
	TScriptInterface<class ISlateTextureAtlasInterface> CallFunc_SetBrushFromAtlasInterface_AtlasRegion_CastInput; // 0x0118(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
struct WBP_DailyChallengeReward_C_InitializeInfamyReward
{
public:
...
struct WBP_DailyChallengeReward_C_InitializeReward
{
public:
...
struct WBP_DailyChallengeReward_C_PreConstruct
{
public:
