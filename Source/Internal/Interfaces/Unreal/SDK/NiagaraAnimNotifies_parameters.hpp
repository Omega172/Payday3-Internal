...
struct AnimNotifyState_TimedNiagaraEffect_GetSpawnedEffect
{
public:
...
// 0x0010 (0x0010 - 0x0000)
struct AnimNotifyState_TimedNiagaraEffectAdvanced_GetNotifyProgress
{
public:
	class UMeshComponent*                         MeshComp;                                          // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct AnimNotify_PlayNiagaraEffect_GetSpawnedEffect
{
public:
