...
#include "WBP_UI_Widget_ArmorChunk_classes.hpp"
#include "WBP_UI_Widget_ArmorChunk_parameters.hpp"
...
void UWBP_UI_Widget_ArmorChunk_C::ExecuteUbergraph_WBP_UI_Widget_ArmorChunk(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Widget_ArmorChunk_C", "ExecuteUbergraph_WBP_UI_Widget_ArmorChunk");

	Params::WBP_UI_Widget_ArmorChunk_C_ExecuteUbergraph_WBP_UI_Widget_ArmorChunk Parms{};
...
void UWBP_UI_Widget_ArmorChunk_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("WBP_UI_Widget_ArmorChunk_C", "PreConstruct");
