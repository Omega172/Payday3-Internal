...
{
public:
	TMap<ESlatePostRT, class USlateRHIPostBufferProcessor*> SlatePostBufferProcessors;               // 0x0038(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	TMap<ESlatePostRT, struct FSlatePostSettings> SlatePostSettings;                                 // 0x0048(0x0050)(Edit, EditFixedSize, Config, NativeAccessSpecifierPrivate)
