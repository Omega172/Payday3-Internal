...
struct ReplicationGraphDebugActor_ClientCellInfo
{
public:
...
struct ReplicationGraphDebugActor_ServerPrintAllActorInfo
{
public:
...
struct ReplicationGraphDebugActor_ServerSetConditionalActorBreakpoint
{
public:
...
// 0x0010 (0x0010 - 0x0000)
struct ReplicationGraphDebugActor_ServerSetCullDistanceForClass
{
public:
...
// 0x0010 (0x0010 - 0x0000)
struct ReplicationGraphDebugActor_ServerSetPeriodFrameForClass
{
public:
	class UClass*                                 Class_0;                                           // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
