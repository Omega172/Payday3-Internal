...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// ETextCasing                             InCasing                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UTextBlock::SetTextCasing(ETextCasing InCasing)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TextBlock", "SetTextCasing");

	Params::TextBlock_SetTextCasing Parms{};

	Parms.InCasing = InCasing;
...
float UUserWidget::GetAnimationLength(const class UWidgetAnimation* InAnimation) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UserWidget", "GetAnimationLength");

	Params::UserWidget_GetAnimationLength Parms{};
