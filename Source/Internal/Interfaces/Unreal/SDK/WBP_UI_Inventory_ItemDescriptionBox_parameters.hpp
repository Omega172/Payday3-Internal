...
struct WBP_UI_Inventory_ItemDescriptionBox_C_SetInventoryItem
{
public:
	class USBZInventoryBaseData*                  InInventoryItem;                                   // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class USBZArmorData*                          K2Node_DynamicCast_AsSBZArmor_Data;                // 0x0058(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	const class USBZWeaponPartDataAsset*          K2Node_DynamicCast_AsSBZWeapon_Part_Data_Asset;    // 0x0068(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class USBZBaseWeaponData*                     K2Node_DynamicCast_AsSBZBase_Weapon_Data;          // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class USBZToolData*                           K2Node_DynamicCast_AsSBZTool_Data;                 // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_TextIsEmpty_ReturnValue;                  // 0x010C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Greater_IntInt_ReturnValue;               // 0x010D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x010E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_10F[0x1];                                      // 0x010F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class USBZEquippableData*                     K2Node_DynamicCast_AsSBZEquippable_Data;           // 0x0110(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_Variable_1;                              // 0x0165(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_166[0x2];                                      // 0x0166(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   K2Node_Select_Default;                             // 0x0168(0x0010)()
	struct FSlateColor                            K2Node_MakeStruct_SlateColor;                      // 0x0178(0x0014)()
	uint8                                         Pad_18C[0x4];                                      // 0x018C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSBZWeaponModificationUIData           CallFunc_Array_Get_Item;                           // 0x0190(0x0010)()
	...
	struct FSBZWeaponModificationUIData           CallFunc_Array_Get_Item_1;                         // 0x01C8(0x0010)()
	...
	TArray<class USBZInventoryBaseData*>          Temp_object_Variable;                              // 0x0240(0x0010)(ConstParm, ReferenceParm)
	struct FSlateColor                            K2Node_Select_Default_1;                           // 0x0250(0x0014)()
	uint8                                         Pad_264[0x4];                                      // 0x0264(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetFormattedDescriptionText_ReturnValue;  // 0x0268(0x0010)()
};
