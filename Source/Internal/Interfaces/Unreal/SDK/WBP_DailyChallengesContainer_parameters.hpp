...
struct WBP_DailyChallengesContainer_C_CreateChallengeButton
{
public:
	class UWBP_DailyChallengeItem_C*              OutChallengeButtonWidget;                          // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UWBP_DailyChallengeItem_C* ChallengeButton)> K2Node_CreateDelegate_OutputDelegate; // 0x0008(0x0014)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FSlateChildSize                        K2Node_MakeStruct_SlateChildSize;                  // 0x001C(0x0008)(NoDestructor)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_DailyChallengeItem_C*              CallFunc_Create_ReturnValue;                       // 0x0028(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct WBP_DailyChallengesContainer_C_ExecuteUbergraph_WBP_DailyChallengesContainer
{
public:
	...
	class UWBP_DailyChallengeItem_C*              CallFunc_CreateChallengeButton_OutChallengeButtonWidget; // 0x0008(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate;              // 0x0038(0x0014)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_GetFeatureToggleValue_ReturnValue;        // 0x0184(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct WBP_DailyChallengesContainer_C_InitializeDailyChallenges
{
public:
	...
	class UWBP_DailyChallengeItem_C*              CallFunc_Array_Get_Item;                           // 0x0018(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct WBP_DailyChallengesContainer_C_OnChallengeRerollPopupClosed
{
public:
...
struct WBP_DailyChallengesContainer_C_OnChallengeRerollPressed
{
public:
	class UWBP_DailyChallengeItem_C*              ChallengeButton;                                   // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FSBZUIPopupData                        K2Node_MakeStruct_SBZUIPopupData;                  // 0x00C0(0x0050)(ContainsInstancedReference)
};

// Function WBP_DailyChallengesContainer.WBP_DailyChallengesContainer_C.PreConstruct
// 0x0001 (0x0001 - 0x0000)
struct WBP_DailyChallengesContainer_C_PreConstruct
{
public:
...
struct WBP_DailyChallengesContainer_C_UpdateTimer
{
public:
	class USBZTimeEventManager*                   CallFunc_Get_ReturnValue;                          // 0x0000(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
