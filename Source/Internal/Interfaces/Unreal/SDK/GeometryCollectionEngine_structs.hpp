...
public:
	...
	TArray<class UMaterialInterface*>             SourceMaterial;                                    // 0x0090(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
