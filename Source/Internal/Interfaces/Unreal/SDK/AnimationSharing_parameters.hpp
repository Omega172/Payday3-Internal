...
struct AnimationSharingStateProcessor_GetAnimationStateEnum
{
public:
...
struct AnimationSharingStateProcessor_ProcessActorState
{
public:
...
struct AnimSharingStateInstance_GetInstancedActors
{
public:
...
struct AnimationSharingManager_AnimationSharingEnabled
{
public:
...
// 0x0018 (0x0018 - 0x0000)
struct AnimationSharingManager_CreateAnimationSharingManager
{
public:
...
// 0x0010 (0x0010 - 0x0000)
struct AnimationSharingManager_GetAnimationSharingManager
{
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// 0x0010 (0x0010 - 0x0000)
struct AnimationSharingManager_RegisterActorWithSkeletonBP
{
public:
