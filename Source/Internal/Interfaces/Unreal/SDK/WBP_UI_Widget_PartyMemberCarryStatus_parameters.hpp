...
public:
	...
	const class USBZCarryType*                    K2Node_Event_DroppedCarryType;                     // 0x0008(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	const class USBZCarryType*                    K2Node_Event_PickedUpCarryType;                    // 0x0010(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_UI_Widget_CrewCarryStatusItem_C*   K2Node_DynamicCast_AsWBP_UI_Widget_Crew_Carry_Status_Item; // 0x0038(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0040(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_UI_Widget_CrewCarryStatusItem_C*   CallFunc_Create_ReturnValue;                       // 0x0048(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_UI_Widget_CrewCarryStatusItem_C*   K2Node_DynamicCast_AsWBP_UI_Widget_Crew_Carry_Status_Item_1; // 0x0068(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_WBP_UI_Widget_PartyMemberCarryStatus_C_ExecuteUbergraph_WBP_UI_Widget_PartyMemberCarryStatus;
...
DUMPER7_ASSERTS_WBP_UI_Widget_PartyMemberCarryStatus_C_OnCarryTypeDropped;
...
DUMPER7_ASSERTS_WBP_UI_Widget_PartyMemberCarryStatus_C_OnCarryTypePickedUp;
