...
struct BPL_WeaponStatsLibrary_C_GenerateWeaponModStatsString
{
public:
	const class USBZBaseWeaponData*               WeaponData;                                        // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	const class USBZEquippablePartDataAsset*      ModData;                                           // 0x0008(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	const class USBZWeaponSightData*              CallFunc_Array_Get_Item;                           // 0x0060(0x0008)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FSBZWeaponModificationUIData           CallFunc_Array_Get_Item_1;                         // 0x0110(0x0010)()
	...
	struct FSBZWeaponModificationUIData           CallFunc_Array_Get_Item_2;                         // 0x0138(0x0010)()
	...
	double                                        CallFunc_Conv_DoubleToString_InDouble_ImplicitCast; // 0x01C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
