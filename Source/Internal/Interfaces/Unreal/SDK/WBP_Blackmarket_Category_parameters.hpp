...
struct WBP_Blackmarket_Category_C_ExecuteUbergraph_WBP_Blackmarket_Category
{
public:
	...
	class UWBP_UI_MainMenu_StoreItemButton_C*     CallFunc_Create_ReturnValue;                       // 0x0020(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   K2Node_Event_InCategoryName;                       // 0x0038(0x0010)(ConstParm)
	ESBZStoreItemDefaultUICategory                K2Node_Event_CategoryType;                         // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct WBP_Blackmarket_Category_C_PreConstruct
{
public:
...
struct WBP_Blackmarket_Category_C_SetStoreCategoryName
{
public:
	class FText                                   InCategoryName;                                    // 0x0000(0x0010)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};

// Function WBP_Blackmarket_Category.WBP_Blackmarket_Category_C.UpdateCategoryVisuals
// 0x0001 (0x0001 - 0x0000)
struct WBP_Blackmarket_Category_C_UpdateCategoryVisuals
{
public:
